...
public class PojoTest {
    ...
    @Before
    public void setup() {
        pojoClasses = new ArrayList<PojoClass>();// PojoClassFactory.getPojoClasses(POJO_PACKAGE, new FilterPackageInfo());
        pojoClasses.add(PojoClassFactory.getPojoClass(Event.class));
